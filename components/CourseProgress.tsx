...
export function CourseProgress({
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-purple-50 border-4 border-black rounded-xl p-6 md:p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="mb-4">
            ...
            <div className="w-full h-6 bg-white border-2 border-black rounded-full overflow-hidden shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
              <div
        ...
        <div className="flex-shrink-0">
          {hasStarted && !isCompleted && lastAccessedLessonId ? (
            <Link href={`/courses/${bookId}/lessons/${lastAccessedLessonId}`}>
              <Button
                size="lg"
                className="w-full md:w-auto border-4 border-black bg-blue-500 hover:bg-blue-600 text-white font-bold text-lg py-6 px-8 rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all"
              >
                Resume Learning
